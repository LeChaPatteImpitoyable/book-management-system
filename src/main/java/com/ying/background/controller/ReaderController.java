...
import com.ying.background.services.ReaderCardService;
import com.ying.background.services.ReaderInfoService;
...
public class ReaderController {
    ...
    public ModelAndView allReaders(){
        int totalCount = readerInfoService.getReaderInfosCount();
        ModelAndView modelAndView=new ModelAndView("admin_readers");
        if(totalCount > 0){
            modelAndView.addObject("readers",readerInfoService.gePagetReaderInfos(1, 9));
        }
    ...
    public ModelAndView allReadersDo(int curPage, int pageSize){
        int totalCount = readerInfoService.getReaderInfosCount();
        ...
        if(totalCount > 0){
            ...
            modelAndView.addObject("readers",readerInfoService.gePagetReaderInfos(curPage, pageSize));
        }
        modelAndView.addObject("totalCount", totalCount);
        return modelAndView;
    }
    ...
    @ResponseBody
    public Boolean getReaderInfoDo(HttpServletRequest request) {
        int readerId= Integer.parseInt(request.getParameter("readerId"));
    ...
    public ModelAndView getLenovoReader(HttpServletRequest request, HttpServletResponse response) throws Exception {
